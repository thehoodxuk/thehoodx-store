...
_(Note: The backend has been updated to redirect to `/success` and `/cancel` instead of `/success.html` and `/cancel.html` to match standard Next.js clean routing.)_
